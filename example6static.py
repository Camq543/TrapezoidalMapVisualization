...
def generate_segments(num_segments, xlim, ylim):
    ...
    return segments
e1 = Edge(Point(1,28), Point(2,27))
e2 = Edge(Point(34,19), Point(50,37))
e3 = Edge(Point(19,55), Point(37,92))
e4 = Edge(Point(77,0), Point(82,41))
e5 = Edge(Point(23,39), Point(60,49))
e6 = Edge(Point(47,16), Point(72,40))
e7 = Edge(Point(7,98), Point(10,76))
e8 = Edge(Point(17,65), Point(38,99))
e9 = Edge(Point(26,55), Point(85,79))
e10 = Edge(Point(75,95), Point(86,90))
